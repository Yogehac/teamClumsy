...
class final_csv:
    ...
    def getreq(self):
        ...
        self.csvpath = sfex(reqxlpath).opcsvfile
    ...
    def final_function(self):
            ...
            for y,z in cli_dict.items():
                ...
                for rows in dict_of_rows_comp[0:]:
                    ...
                    if rows["Quantity"] == ' ':
                        rows["Quantity"] = 0
                    # print(rows)
                    rows["Amount"] = int(float(rows["Rate"])) * int(float(rows["Quantity"]))
        ...
        # print(dict_of_rows_request)
        # print(lastdictlist)
        self.makeFinal(lastdictlist,"nakku.csv")
